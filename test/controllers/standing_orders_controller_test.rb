...
class StandingOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create standing_order" do
    assert_difference('StandingOrder.count') do
      post standing_orders_url, params: { standing_order: { is_active: @standing_order.is_active, quantity: @standing_order.quantity, weekday: @standing_order.weekday } }
    end
  ...
  test "should update standing_order" do
    patch standing_order_url(@standing_order), params: { standing_order: { is_active: @standing_order.is_active, quantity: @standing_order.quantity, weekday: @standing_order.weekday } }
