...
class OrderProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_product" do
    assert_difference('OrderProduct.count') do
      post order_products_url, params: { order_product: { order_id: @order_product.order_id, product_id: @order_product.product_id, quantity: @order_product.quantity, quantity_type_id: @order_product.quantity_type_id, standing_order_id: @order_product.standing_order_id } }
    end
  ...
  test "should update order_product" do
    patch order_product_url(@order_product), params: { order_product: { order_id: @order_product.order_id, product_id: @order_product.product_id, quantity: @order_product.quantity, quantity_type_id: @order_product.quantity_type_id, standing_order_id: @order_product.standing_order_id } }
